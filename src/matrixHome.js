...
function theMatrixHome(altura,largura){
    ...
    const audioMatrix = new Audio(audio);
    export const play = () => {
        audioMatrix.play();
    };
...
var chuvamatrix = document.getElementById('MatrixHome');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

var chuvamatrix = document.getElementById('chuvaHome0');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

var chuvamatrix = document.getElementById('chuvaHome1');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

var chuvamatrix = document.getElementById('chuvaHome2');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

var chuvamatrix = document.getElementById('chuvaHome3');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;
}
...
function desenhaMatrix() {
    for (var i = 0; i < numLin; i++) {
        ...
        for (var j = 0; j < numCol; j++) {
            caseHome[i][j]= [];
            for (var n = 0; n < 4; n++) {
                caseHome[i][j][n] = document.createElement("div");
                caseHome[i][j][n].setAttribute('class', `caseHome`);
                caseHome[i][j][n].setAttribute('id', `caseHome${i}.${j}.${n}`);
                document.getElementById(`chuvaHome${n}`).appendChild(caseHome[i][j][n]);
            }
        }
    }
    for (var i = 0; i < numLin; i++) {
        ...
        for (var j = 0; j < numCol; j++) {
            ...
            for (var n = 0; n < 4; n++) {
                ...
                document.getElementById(`caseHome${i}.${j}.${n}`).appendChild(matrix[i][j][n]);
...
async function anima1() {
    ...
    for (var j = 0; j < numCol; j++) {
        ...
        if (aLi1[j] == 0) {
                ...
                matrix[aLi1[j]][sequenciaemVChuva0[j]][1].setAttribute('class', 'numBrilhaHome');
            ...
            if (aLi1[j] <= numLin && aLf1[j] == 0) {
                    ...
                    matrix[aLi1[j] - 1][sequenciaemVChuva0[j]][1].setAttribute('class', 'numNeutroHome');
                ...
                if (temporizadorI1[j] >= numLin && aLf1[j] == 0) {
                        ...
                        matrix[aLi1[j]][sequenciaemVChuva0[j]][1].setAttribute('class', 'numNeutroHome');
...
async function anima2() {
    ...
    for (var j = 0; j < numMensBV; j++) {
        ...
        if (aLi2[j] == 0) {
                ...
                matrix[aLi2[j]][sequenciaemV[j]][2].setAttribute('class', 'numBrilhaHome');
            ...
            if (aLi2[j] < numLin2 && aLf2[j] == 0) {
                    ...
                    matrix[aLi2[j] - 1][sequenciaemV[j]][2].setAttribute('class', 'numNeutroHome');
                ...
                if (temporizadorI2[j] > numLin2   && aLf2[j] == 0) {
                        ...
                        matrix[aLi2[j]][sequenciaemV[j]][2].setAttribute('class', 'numNeutroHome');
    ...
    for (var j = 0; j < numNome; j++) {
        ...
        if (temporizadorI3[j] >= comprimento3[j] && aLf3[j] < numLin3-1) {
            ...
            if (temporizadorF3[j] > (numLin/2) * 5 ) {
                ...
                var recebe = document.getElementById("chuvaHome3");
                recebe.style.marginTop = `${realocaChuvasTxt(altura,largura)}px`;
...
function atualizaBusto(){
    ...
    var busto = document.getElementById('imgBustoHome1');
    busto.style.display = 'none';
