        ...
        <div>
            <div id="Menu" className="oculta">
                ...
                <div id='Gavetas' className="mostra">
                    {seforAdm() && (
                        <div onClick={abrirUsers} id="gavetaUsers">USERS</div>
                    )}
                    <div onClick={abrirForms} id="gavetaForms">MENSAGENS</div>
                    <div onClick={logoff} className="gavetaItem">ENCERRAR</div>
                </div>
