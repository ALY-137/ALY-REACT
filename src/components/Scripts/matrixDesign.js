...
function theMatrixDesign(altura,largura){
...
var chuvamatrix = document.getElementById('MatrixDesign');
    ...
    for (i = 0; i < numLin; i++) {
        ...
        for (j = 0; j < numCol; j++) {
            ...
            for (n = 0; n < 4; n++) {
                ...
                document.getElementById(`chuvaDesign${n}`).appendChild(CaseDesign[i][j][n]);
            }
        }
    }
    for (i = 0; i < numLin; i++) {
        ...
        for (j = 0; j < numCol; j++) {
            ...
            for (n = 0; n < 4; n++) {
                ...
                document.getElementById(`caseDesign${i}.${j}.${n}`).appendChild(matrix[i][j][n]);
...
function centralizaNome() {
    var elemento = document.getElementById('chuvaDesign3');
