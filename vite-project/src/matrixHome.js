...
chuvamatrix = document.getElementById('chuvaHome0');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

chuvamatrix = document.getElementById('chuvaHome1');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

chuvamatrix = document.getElementById('chuvaHome2');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;

chuvamatrix = document.getElementById('chuvaHome3');
chuvamatrix.style.height = `${chuvaAltura}px`;
chuvamatrix.style.width = `${chuvaLargura}px`;
}
